...
const { createUser, createReview, createComment, createItem } = require("./index");
...
const items = [
  ...
  },
  {
    name: "Don Julio 1942",
    description:
      "A tequila only produced in small batches that have been aged a minimum of two and a half years. A tribute to Don Julio Gonzalez and handmade in the traditional way.",
  ...
  },
  {
    ...
    description:
      'Premium reposado tequila aged eight months in American whiskey casks that gives an exceptionally smooth finish. Comes in their iconic decanter with a hand painted "feathered" design.',
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Premium blended whisky from Suntory.  Made with more than ten malt and grain whiskies and aged in five different types of casks.  Complex fruit and spice flavor with a hint of smokiness.",
  ...
  },
  {
    ...
    description:
      "Americas first craft vodka, Titos from Austin, Texas, has been the choice for trendy cocktailians since it hit the market in 1997. It is made from corn for a deep, rich flavor, and Abou-Ganim is a long-time fan.",
  ...
  },
  {
    ...
    imageUrl:
      "https://d3r6kbofdnmd8.cloudfront.net/media/catalog/product/cache/image/390x390/a4e40ebdc3e371adff845072e1c73f37/1/0/102726_bacardi_carta_blanca_700.jpg",
    price: "19.95",
    alcoholContent: "37.5",
    category: "Rum",
  },
  {
    ...
    description:
      "A special dark spiced version of Captain Morgan, made with Caribbean rums, spices and natural flavourings, matured in oak and designed to be drunk on its own.",
  ...
  },
  {
    ...
    description:
      "Category-dominating Christmas best-seller blended from cream, cocoa and Irish whiskey. Instrumental in a variety of shooters.",
  ...
  },
  {
    ...
    description:
      "Jose Cuervo Especial® Gold is a golden blend of younger tequilas. The light gold spirit has a sweet aroma with pleasant agave notes. Along with its sweet, subtle agave flavor and hints of oak and vanilla, Especial Gold boasts a well-balanced, short, smooth finish.",
  ...
  },
  {
    ...
    description:
      "Maestro Dobel Silver is a double-distilled Tequila which, unusually, is not rested and is bottled straight from the still with only water added to dilute it to drinking strength. A superb, complex, cocktail ingredient.",
  ...
  },
  {
    ...
    description:
      "Korea- Infused with fresh, sweet-tasting plums. Jinro Plum has become one of the most popular fruit infused Soju in Korea and represents a new twist on a Korean favorite. It is best served ice-cold, neat, or as a small pour in a chilled traditional cup.",
  ...
  },
  {
    name: "Corona Extra",
    description:
      "Some sweet malt and a bit of that signature skunkiness come through on the nose, along with a hint of citrus and green apple.",
  ...
  },
  {
    ...
    description:
      "Canada- Nose is full of grated cinnamon which carries over to the body full of spice, sugar, and a long, lingering cinnamon burn. The balance is right and the tastes are authentic. Tastes like heaven; burns like hell.",
  ...
  },
  {
    ...
    description:
      "New York- Fruit Cider- This crisp and refreshing cider mixes the sweetness of the apples with a subtle dryness for a balanced cider taste. The fresh apple aroma and slightly sweet, ripe apple flavor make this cider hard to resist.",
  ...
  },
  {
    ...
    description:
      "Lemonade- 5% ABV. A hard day calls for a hard lemonade. The ultimate refresher, mikes hard lemonade combines natural lemon flavors with a kiss of carbonation.",
  ...
  },
  {
    ...
    description:
      "firm, intense and concentrated, with flavors of ripe apple, juicy melon, honeysuckle, pineapple and vanilla. A rich mouthfeel balanced with just enough acidity.",
  ...
  },
  {
    ...
    description:
      "A herbaceous and tropical Sauvignon Blanc featuring fresh green melon, citrus, and grapefruit flavors. It is refreshing on the palate and has a crisp, mouth-watering finish.",
  ...
  },
  {
    ...
    description:
      "White Claw Hard Seltzer is the nation's leading hard seltzer known for pure, crisp refreshment. This 24 pack will cater to any and all occasions and will please any crowd.",
  ...
  },
  {
    ...
    description:
      "From the famous Barton 1792 Distillery, a BiB that brings to life powerful, vanilla bean and leather aroma followed by a leathery finish.",
  ...
  },
  {
    ...
    description:
      "A classic London dry gin that's juniper forward with a nice balance of botanicals. This gin features a botanical blend of juniper, coriander, orange, and angelica root. Perfect to enjoy with your favorite tonic.",
  ...
  },
  {
    ...
    description:
      "Velvet blend of an oaky eaux-de-vie.  This cognac lives up to the name with a taste of opulence only royals have enjoyed.",
    imageUrl:
      "https://static-prod.remymartin.com/app/uploads/2023/10/teaser-l2-remy-martin-1738-accord-royal-buy-online-231027-461x600.jpg",
    price: "80.00",
    alcohol_content: "40",
    category: "Cognac",
  },
  {
    ...
    description:
      "Only rare Scotch Whiskies with remarkable flavor get chosen for this spirit.  Only one in ten thousand barrels get chosen.  Best served neat.",
  ...
  },
  {
    name: "Buffalo Trace",
    description:
      "Made from the corn, rye, and barely malt and distilled, aged, and bottle at the most award-winning distillery in the world.  This whiskey ages in new oak barrels until mature.",
  ...
  },
  {
    ...
    description:
      "Grey goose vodka mixed with a dash of cognac that adds just enough complexity.  Tastes of signature grey goose vodka with fruit and floral notes that is best enjoyed on the rocks.",
  ...
  },
  {
    ...
    description:
      "Matured for 26 years, with over 2 years in cognac casks that adds layers of sweet oak and brown sugar, this is the epitome of opulence.  A crown fit for the grandest of occasions.",
  ...
  },
  {
    ...
    imageUrl:
      "https://www.reservebar.com/dw/image/v2/BJBF_PRD/on/demandware.static/-/Sites-reserveba[…]es/19954a63848c2aa58520454a7da96ed4f198d651.png?sh=630&q=80",
    price: "81.00",
  ...
  },
  {
    ...
    description:
      "Complex aromas and a well-integrated taste that pervades the experience.  This masterfully crafted bourbon is the only bourbon that won double gold five times at the San Francisco World Spirits Competition.",
  ...
  },
  {
    ...
    imageUrl:
      "https://www.blantonsbourbon.com/cdn/shop/files/Product_Page_Gold_International_Domestic_38fea3fe-5609-4984-b9e3-f8e9aab4ec85_1080x.jpg?v=1613787518",
    price: "249.99",
  ...
  },
  {
    ...
    description:
      "The base from which all other Don Julio variants are derived.  Crisp agave flavor makes for a great ingredient in mixing. Can also be enjoyed neat or on the rocks.",
  ...
  },
  {
    ...
    description:
      "Handmade and aged inside century old warehouses constructed by E.H. Taylor, Jr.  Each barrel has been evaluated and selected to create a prefect blend of distinctive character.  A true sipping bourbon.",
    imageUrl:
      "https://www.buffalotracedistillery.com/our-brands/e-h-taylor-jr/e-h-taylor-jr-small-batch/_j[…]631043068049/eh-taylor-small-batch-desktop-bottle.png",
    price: "185.00",
    alcohol_content: "50",
    category: "Bourbon",
  },
  {
    ...
    description:
      "Single Malt from Islay, Scotland.  This scotch has a rich peat character and smoke like no other.  Best enjoyed by sipping and pairs well with a cigar.",
  ...
  },
  {
    name: "Glenlivet 25",
    description:
      "Matured in traditional casks and finished in first fill Pedro Ximénez Sherry & Tronçais Oak Cognac casks, This scotch brings an indulgent richness to the iconic style of Glenlivet. ",
  ...
  },
  {
    name: "Louis XIII",
    description:
      "The finest eaux-de-vie, made using grapes grown in Grande Champagne - the premier cru of the Cognac region.  The eaux-de-vie is aged for decades in old Limousin tierçons for decades before being bottle in hand-crafted unique decanters.",
...
const reviews = [
  {
    ...
    user_id: "1",
    content:
      "If you are going to try a Japanese whiskey, you can do a lot worse than Hibiki Harmony.  It has the mellower flavors common of Japanese whiskey but brings a complex profile that even drinkers who prefer higher proofs will enjoy.",
    rating: "88",
  },
  {
    item_id: "4",
    user_id: "5",
    content:
      "Way too sweet.  After spending a preimum, I expected a premium experience.  While it has a nice, smooth flavor at first, it is then ruined by an overly strong sweetness.  Would not recommend for the price.  At least the bottle is nice.",
    rating: "45",
  },
  {
    item_id: "4",
